  ...
  <section id="contact" className="container py-16 md:py-24 px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid gap-8 md:grid-cols-2">
      <Card className="bg-white/50 backdrop-blur-sm shadow-lg">
        <CardHeader>
          <CardTitle className={cn("text-2xl font-semibold", theme.typography.fontFamily.sans)}>Contact Information</CardTitle>
      ...
      <Card className="bg-white/50 backdrop-blur-sm shadow-lg">
        <CardHeader>
          <CardTitle className={cn("text-2xl font-semibold", theme.typography.fontFamily.sans)}>Send a Message</CardTitle>
